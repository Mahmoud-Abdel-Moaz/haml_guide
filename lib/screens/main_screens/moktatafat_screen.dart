...
class _MoktatfatScreenState extends State<MoktatfatScreen> {
 ...
 late Future<List<BannerCustomModel>> _bannerCustom;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body:_fetchMoktatafatList!=null? FutureBuilder(
                        ...
                        itemBuilder: (context, index) => Consumer(
                          builder: (context, watch, child) => Column(
                            children: [
                              index == 2
                                  ? SizedBox(
                                      ...
                                      child: bannerCustom.isNotEmpty
                                          ...
                                          : (_myBannerAdd!=null?CommonComponents.showBannerAds(
                                              _myBannerAdd!):null),
                                    )
                                  : const SizedBox(),
                              SizedBox(height: 10.0.h),
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Icon(
                                        (moktataftList[index].visibility??false)
                              ...
                              SizedBox(height: 10.0.h),
                              Visibility(
                                visible: (moktataftList[index].visibility??false),
                                child: Container(
                                  padding: EdgeInsets.all(10.0.h),
